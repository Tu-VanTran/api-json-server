...
const router = jsonServer.router('data.json')//chổ này nếu bạn đăt tên file json khác thì sửa ở đây
...
server.listen(process.env.PORT || 3333, () => {// nếu muốn thay đổi cổng lắng nghe thì đổi ở đây mặc định mình để 3003 để tránh trùng với reactjs 
